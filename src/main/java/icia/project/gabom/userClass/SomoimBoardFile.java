...
@Service
public class SomoimBoardFile {
	 //파일 업로드 메소드   
		
		//String fullPath = "D:\\springWork\\.metadata\\.plugins\\org.eclipse.wst.server.core\\tmp0\\wtpwebapps\\SpringMVCBoard\\upload\\";
		
		String fullPathmain = "D:\\springWork\\gabom\\src\\main\\webapp\\resources\\somoimboard\\";
		@Autowired
		private IhouseDao hDao;
		
	   public boolean fileUpProfilePic(MultipartHttpServletRequest multi, String picName, String sysfile){
		   System.out.println("fileUp");
		      ...
		      String real=sysRoot_path+"\\gabom\\upload\\somoimboard\\";
...
//	         //3.파일을 가져오기-파일태그가 1개 일때   //sys 파일 가져오기
	         MultipartFile member_profile_picture = multi.getFile(picName);
	         System.out.println("file 파일명 : " + member_profile_picture.getOriginalFilename());
	         ...
	         //5.메모리->실제 파일 업로드
	         System.out.println("실제 경로  : " + path+sysFileName);
	         try {
